...
export const PricingCard = ({ metadata }: { metadata: any }) => {
  return (
    <div style={{
      ...
      padding: '16px', maxWidth: '300px', fontFamily: 'sans-serif',
      boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)'
    }}>
      <h3 style={{ margin: '0 0 8px 0', fontSize: '18px', color: '#1e293b' }}>{metadata.title || 'Тариф Pro'}</h3>
      <p style={{ margin: '0 0 16px 0', fontSize: '24px', fontWeight: 'bold', color: '#0f172a' }}>
